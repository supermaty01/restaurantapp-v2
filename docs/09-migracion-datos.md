...
1. **Backup automático previo**: se genera un export completo (formato backup, ver abajo) a un archivo local _antes_ de tocar nada. Si la migración falla, la app lo comunica y el archivo queda disponible; la migración es reintentable.
