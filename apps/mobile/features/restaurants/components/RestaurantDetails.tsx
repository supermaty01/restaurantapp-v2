    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }} nestedScrollEnabled>
      <View className="p-4 bg-card dark:bg-dark-card flex-1">
        ...
        {restaurant.tags && restaurant.tags.length > 0 ? (
          ...
          <Text className="text-sm italic text-[#999] dark:text-gray-500 mb-4">Sin etiquetas</Text>
        )}
        ...
        {restaurant.latitude && restaurant.longitude ? (
          ...
          <Text className="text-sm italic text-[#999] dark:text-gray-500">Sin ubicación</Text>
        )}
