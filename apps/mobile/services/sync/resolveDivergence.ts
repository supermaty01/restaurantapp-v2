 ...
 * diarios, hay uno, y volver a preguntarlo no puede terminar bien.
 */
...
/** Lo llama el gestor de sync tras cada pasada correcta. */
 ...
 *
 * ## Por qué «primera vez» no puede leerse de la bandeja de salida
 *
 * Antes la señal era «hay cambios sin subir», como sustituto de «este móvil ya
 * escribía antes de esta cuenta». No lo es: la bandeja tiene algo cada vez que
 * se escribe una entrada y todavía no ha corrido el sync. Basta con guardar una
 * comida y cerrar la app —o que la pasada fallara por falta de red— para que el
 * siguiente arranque anunciara «hay dos diarios» a alguien que solo ha usado la
 * app en un teléfono. Y como la marca solo se escribía al *elegir*, cerrar la
 * pantalla hacía que volviera a salir en cada arranque.
 *
 * La pregunta correcta es si este dispositivo ha llegado a sincronizar alguna
 * vez con esta cuenta, y eso se responde con una marca propia que pone el sync
 * al terminar bien.
 */
